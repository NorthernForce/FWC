            ...
            <div className="service-container">
                ...
                <div className="service-cameras">
                    <Canvas className="service-camera">
                        <CanvasMjpgStream className="service-camera-stream" origin={[0,0]} crosshairColor="white" width={320} height={240} srcs={["mjpg:http://10.1.72.47:1181/?action=stream"]}/>
                    </Canvas>
                    <Canvas className="service-camera">
                        <CanvasMjpgStream className="service-camera-stream" origin={[0,0]} crosshairColor="white" width={320} height={240} srcs={["mjpg:http://10.1.72.31:1181/?action=stream"]}/>
                    </Canvas>
                </div>
            </div>
        </>
